...
function Menu({ titles }) {
    ...
    const onNavigate = (path) => {
        const timer = setTimeout(() => { navigate(path) }, 1000)
    ...
    const content = titles.map((title) => <div className="menu__item" onClick={() => onNavigate(title.route)}>
        <div className="menu__switch">
            <div className="menu__switch__circle">
                <div className="menu__switch__hole">
                    <div className="menu__switch__tip">
