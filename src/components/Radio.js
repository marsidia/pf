...
function Radio() {
    ...
    return(
        <div className="radio">
            <div className="radio__transition" ref={transitionRef}>
            ...
            <div className="form">
                        ...
                        <div className="form__border">
                            <div className="form__numbers">
                                ...
                                <div className="form__numbers__num form__numbers__num--1">
                                    <div className="form__numbers__num__text">
                                        1
                                    </div>
                                ...
                                <div className="form__indicator" ref={indicatorRef}>
                ...
                <div className="labels" >
                    ...
                    <div className="labels__label"
                        ...
                        onClick={() => setNavi("/curriculum")}> <span className="labels__bullet" ></span>2 - Curriculum Vitae
                    </div>
                    <div className="labels__label"
                        onMouseEnter={() => onHover(3)}
                        onClick={() => setNavi("/projects")}><span className="labels__bullet" ></span>3 - Projets
                    </div>
                </div>
                {/* </div> */}
